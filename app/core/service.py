...
class WalletService:
    def __init__(self,  db: AsyncSession, network: str = "shasta"):
        self.client = Tron(network=network)
        self.db = db
        self.db_repo = DB_Repository(self.db)
    ...
    async def get_wallet_info(self, wallet_address: str):
        ...
        try:
            ...
            await self.db_repo.add_wallet(wallet_data)
            return wallet_data
